...
#Method:-2: Change the entire static ip routing of route container, hence ietf-routeconf.yml

url = f"https://{device['host']}:{device['port']}/restconf/data/ietf-routing:routing"

with open("ietf-routeconf.yml", "r") as f:
...
url_get = f"https://{device['host']}:{device['port']}/restconf/data/ietf-routing:routing"
